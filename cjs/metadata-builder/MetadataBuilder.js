...
class MetadataBuilder {
    ...
    createMiddlewares(classes) {
        const middlewares = !classes ? [] : index_1.getMetadataArgsStorage().filterMiddlewareMetadatasForClasses(classes);
    ...
    createInterceptors(classes) {
        const interceptors = !classes ? [] : index_1.getMetadataArgsStorage().filterInterceptorMetadatasForClasses(classes);
    ...
    createControllers(classes) {
        const controllers = !classes ? [] : index_1.getMetadataArgsStorage().filterControllerMetadatasForClasses(classes);
